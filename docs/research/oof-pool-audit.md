...
정확·순위 중복과 현행 기여 기준의 반복 제거 뒤 3개가 남았다.
표준 평가 앙상블 OOF AUC는 최초 `0.968677978702`에서 최종 `0.969447220250`로 바뀌었다.
난수 64개와 구성원 복제 대조의 영점 대역은 `-0.021829442476`에서 `+0.000002577949`다.
영점 대역 상한은 ADR 0001의 현행 `기여 > 0` 규칙을 자동 변경하지 않으며, 대역 안의 양수 기여는 별도 결정이 필요한 제거 후보로만 분류한다.

현행 기여 기준 탈락 후보: exp006_te_drop_gaming, exp011_resid_pair, exp022_orig_knn, exp023_orig_proxy_residual, exp026_constrained_impute_nowidth, exp032_recon_orig_mean_top3, exp033_recon_orig_mean_top3_raw, exp035_lattice_te, exp045_xgb_depth8, exp058_logreg_onehot, exp065_tabm, exp067_tabpfn3, exp074_lgb_kitopl_d2_bundle.
고정점 후보의 양수 기여는 모두 영점 대역 상한을 넘었다.
...
| ---: | --- | ---: | ---: | ---: |
| 1 | exp006_te_drop_gaming | -0.000058415123 | 0.968677978702 | 0.968736393825 |
| 2 | exp022_orig_knn | -0.000048198108 | 0.968736393825 | 0.968784591933 |
| 3 | exp026_constrained_impute_nowidth | -0.000053046816 | 0.968784591933 | 0.968837638749 |
| 4 | exp011_resid_pair | -0.000055905425 | 0.968837638749 | 0.968893544174 |
| 5 | exp023_orig_proxy_residual | -0.000054039278 | 0.968893544174 | 0.968947583451 |
| 6 | exp033_recon_orig_mean_top3_raw | -0.000058291698 | 0.968947583451 | 0.969005875149 |
| 7 | exp032_recon_orig_mean_top3 | -0.000053193745 | 0.969005875149 | 0.969059068895 |
| 8 | exp058_logreg_onehot | -0.000060966131 | 0.969059068895 | 0.969120035026 |
| 9 | exp067_tabpfn3 | -0.000072358139 | 0.969120035026 | 0.969192393164 |
| 10 | exp045_xgb_depth8 | -0.000074593322 | 0.969192393164 | 0.969266986486 |
| 11 | exp035_lattice_te | -0.000080771330 | 0.969266986486 | 0.969347757816 |
| 12 | exp065_tabm | -0.000056440546 | 0.969347757816 | 0.969404198362 |
| 13 | exp074_lgb_kitopl_d2_bundle | -0.000043021888 | 0.969404198362 | 0.969447220250 |

고정점 후보: `exp059_lookup_transformer`, `exp070_cat_exact_cats`, `exp081_lookup_fold_initialization_avg3`.
...
| --- | ---: | --- | ---: | ---: | ---: | --- |
| exp006_te_drop_gaming | 0.966592431674 | exp022_orig_knn | 0.996466394406 | 0.989395144148 | -0.000058415123 | 현행 기여 기준 탈락 |
| exp011_resid_pair | 0.967401071703 | exp022_orig_knn | 0.997394283622 | 0.994927156725 | -0.000055905425 | 현행 기여 기준 탈락 |
| exp022_orig_knn | 0.967331098842 | exp011_resid_pair | 0.997394283622 | 0.994927156725 | -0.000048198108 | 현행 기여 기준 탈락 |
| exp023_orig_proxy_residual | 0.967373954625 | exp022_orig_knn | 0.996264613586 | 0.993491611494 | -0.000054039278 | 현행 기여 기준 탈락 |
| exp026_constrained_impute_nowidth | 0.967547642359 | exp032_recon_orig_mean_top3 | 0.997904795064 | 0.996384321945 | -0.000053046816 | 현행 기여 기준 탈락 |
| exp032_recon_orig_mean_top3 | 0.967647221038 | exp033_recon_orig_mean_top3_raw | 0.997946130512 | 0.997585682744 | -0.000053193745 | 현행 기여 기준 탈락 |
| exp033_recon_orig_mean_top3_raw | 0.967620218499 | exp032_recon_orig_mean_top3 | 0.997946130512 | 0.997585682744 | -0.000058291698 | 현행 기여 기준 탈락 |
| exp035_lattice_te | 0.967289719640 | exp026_constrained_impute_nowidth | 0.994121633305 | 0.987930021405 | -0.000080771330 | 현행 기여 기준 탈락 |
| exp045_xgb_depth8 | 0.967936049520 | exp074_lgb_kitopl_d2_bundle | 0.997376668651 | 0.994948173361 | -0.000074593322 | 현행 기여 기준 탈락 |
| exp058_logreg_onehot | 0.959658396372 | exp070_cat_exact_cats | 0.970424166807 | 0.925194891283 | -0.000060966131 | 현행 기여 기준 탈락 |
| exp059_lookup_transformer | 0.968922178533 | exp081_lookup_fold_initialization_avg3 | 0.991421686832 | 0.993383341501 | 0.000070289320 | 유지 |
| exp065_tabm | 0.968326118177 | exp067_tabpfn3 | 0.995049391943 | 0.987721774047 | -0.000056440546 | 현행 기여 기준 탈락 |
| exp070_cat_exact_cats | 0.968579346887 | exp074_lgb_kitopl_d2_bundle | 0.994448538521 | 0.992618197628 | 0.000200018599 | 유지 |
| exp067_tabpfn3 | 0.967243226668 | exp065_tabm | 0.995049391943 | 0.987721774047 | -0.000072358139 | 현행 기여 기준 탈락 |
| exp074_lgb_kitopl_d2_bundle | 0.968398563697 | exp045_xgb_depth8 | 0.997376668651 | 0.994948173361 | -0.000043021888 | 현행 기여 기준 탈락 |
| exp081_lookup_fold_initialization_avg3 | 0.969195761811 | exp059_lookup_transformer | 0.991421686832 | 0.993383341501 | 0.000137096936 | 유지 |
...
난수 변화는 최소 `-0.021829442476`, 중앙값 `-0.021615989029`, 95백분위 `-0.021368384635`, 최대 `-0.021114490790`다.
단독 OOF 최고 후보 `exp081_lookup_fold_initialization_avg3`의 정확 복제 변화는 `+0.000002577949`다.

| 복제 후보 | 기여 변화 |
| --- | ---: |
| exp059_lookup_transformer | -0.000047951573 |
| exp070_cat_exact_cats | -0.000056421872 |
| exp081_lookup_fold_initialization_avg3 | +0.000002577949 |

두 대조를 합친 영점 대역은 `-0.021829442476`에서 `+0.000002577949`다.
